...
export const walkthroughs: GettingStartedWalkthroughContent = [
			...
			steps: [
				{
					...
					description: localize(
						...
						Button(localize('titleID', 'Browse Color Themes'), 'command:workbench.action.selectTheme')
					),
					completionEvents: ['onSettingChanged:workbench.colorTheme', 'onCommand:workbench.action.selectTheme'],
				...
				},
				{
					...
					description: localize(
						...
						"Watch the first in a series of short & practical video tutorials for SideX's key features.\n{0}",
			...
			steps: [
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('toggleMenuBar', 'Toggle Menu Bar'), 'command:workbench.action.toggleMenuBar')
					),
					when: 'isWeb && !isMac',
					media: {
						type: 'svg',
				...
				},
				{
					...
					description: localize(
						...
						"Extensions are SideX's power-ups. They range from handy productivity hacks, expanding out-of-the-box features, to adding completely new capabilities.\n{0}",
						Button(
							localize('browsePopularWeb', 'Browse Popular Extensions'),
					...
					media: {
						type: 'svg',
						altText: 'SideX extension marketplace with featured language extensions',
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('enableSync', 'Backup and Sync Settings'), 'command:workbench.userDataSync.actions.turnOn')
					),
				...
				},
				{
					...
					description: localize(
						...
						'Run commands without reaching for your mouse to accomplish any task in SideX.\n{0}',
						Button(localize('commandPalette', 'Open Command Palette'), 'command:workbench.action.showCommands')
					),
					media: {
						type: 'svg',
				...
				},
				{
					...
					description: localize(
						...
						"You're all set to start coding. You can open a local project or clone a repository to get your files into SideX.\n{0}\n{1}",
						Button(localize('openFolder', 'Open Folder'), 'command:workbench.action.files.openFolder'),
						Button(localize('cloneRepository', 'Clone Repository'), 'command:git.clone')
					),
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('quickOpen', 'Quick Open a File'), 'command:toSide:workbench.action.quickOpen')
					),
					when: 'workspaceFolderCount != 0',
					media: {
						type: 'svg',
	...
	},
	{
		...
		description: localize(
			...
			'Learn the tools and shortcuts that make SideX accessible. Note that some actions are not actionable from within the context of the walkthrough.'
		),
		isFeatured: true,
		icon: setupIcon,
			...
			steps: [
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('openAccessibleView', 'Open Accessible View'), 'command:editor.action.accessibleView')
					),
					media: {
						type: 'markdown',
						path: 'empty'
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('listSignalSounds', 'List Signal Sounds'), 'command:signals.sounds.help'),
						Button(
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('showOrFocusHover', 'Show or Focus Hover'), 'command:editor.action.showHover')
					),
					media: {
						type: 'markdown',
						path: 'empty'
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('toggleFoldRecursively', 'Toggle Fold Recursively'), 'command:editor.toggleFoldRecursively')
					),
					media: {
						type: 'markdown',
						path: 'empty'
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('triggerIntellisense', 'Trigger Intellisense'), 'command:editor.action.triggerSuggest'),
						Button(
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize('terminalStartDictation', 'Terminal: Start Dictation in Terminal'),
							'command:workbench.action.terminal.startVoice'
						),
						Button(
							localize('terminalStopDictation', 'Terminal: Stop Dictation in Terminal'),
			...
			steps: [
				{
					...
					description: localize(
						...
						'Customize every aspect of SideX and [sync](command:workbench.userDataSync.actions.turnOn) customizations across devices.\n{0}',
						Button(localize('tweakSettings', 'Open Settings'), 'command:toSide:workbench.action.openSettings')
					),
					when: "workspacePlatform != 'webworker' && syncStatus != uninitialized",
					completionEvents: ['onEvent:sync-enabled'],
					media: {
						type: 'svg',
						altText: 'SideX Settings',
						path: 'settings.svg'
					}
				},
				{
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('showTerminal', 'Open Terminal'), 'command:workbench.action.terminal.toggleTerminal')
					),
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('runProject', 'Run your Project'), 'command:workbench.action.debug.selectandstart')
					),
...

				{
					...
					description: localize(
						...
						Button(localize('runTasks', 'Run Auto-detected Tasks'), 'command:workbench.action.tasks.runTask')
					),
					media: {
						type: 'svg',
						altText: 'Task runner.',
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('enableTrust', 'enable trust'), 'command:toSide:workbench.trust.manage')
					),
