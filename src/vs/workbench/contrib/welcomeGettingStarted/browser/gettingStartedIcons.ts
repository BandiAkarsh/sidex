...
export const gettingStartedUncheckedCodicon = registerIcon(
	...
	localize('gettingStartedUnchecked', 'Used to represent walkthrough steps which have not been completed')
);
export const gettingStartedCheckedCodicon = registerIcon(
	'getting-started-step-checked',
	Codicon.passFilled,
	localize('gettingStartedChecked', 'Used to represent walkthrough steps which have been completed')
);
