...
suite('Workbench - TerminalConfigurationService', () => {
	...
	suite('getFont', () => {
		...
		test('fontFamily (Linux Fedora)', () => {
			...
			ok(
				terminalConfigurationService.getFont(getActiveWindow()).fontFamily.startsWith("'DejaVu Sans Mono'"),
		...
		test('fontFamily (Linux Ubuntu)', () => {
			...
			ok(
				terminalConfigurationService.getFont(getActiveWindow()).fontFamily.startsWith("'Ubuntu Mono'"),
