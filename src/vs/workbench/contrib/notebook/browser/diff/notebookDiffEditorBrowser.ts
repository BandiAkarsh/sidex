...
export const NOTEBOOK_DIFF_CELLS_COLLAPSED = new RawContextKey<boolean>(
	...
	undefined,
	localize('notebook.diffEditor.allCollapsed', 'Whether all cells in notebook diff editor are collapsed')
);
export const NOTEBOOK_DIFF_HAS_UNCHANGED_CELLS = new RawContextKey<boolean>(
	'notebook.diffEditor.hasUnchangedCells',
	undefined,
	localize('notebook.diffEditor.hasUnchangedCells', 'Whether there are unchanged cells in the notebook diff editor')
);
...
export const NOTEBOOK_DIFF_ITEM_KIND = new RawContextKey<boolean>(
	...
	undefined,
	localize('notebook.diffEditor.item.kind', 'The kind of item in the notebook diff editor, Cell, Metadata or Output')
);
