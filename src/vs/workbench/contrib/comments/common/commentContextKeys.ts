...
export namespace CommentContextKeys {
	 ...
	 */
	export const commentControllerContext = new RawContextKey<string>('commentController', undefined, {
		type: 'string',
	 ...
	 */
	export const commentWidgetVisible = new RawContextKey<boolean>('commentWidgetVisible', false, {
		type: 'boolean',
