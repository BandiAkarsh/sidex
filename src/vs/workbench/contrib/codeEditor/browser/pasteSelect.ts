	...
	properties: {
		'editor.autoSelectOnPaste': {
			...
			description: localize(
				'autoSelectOnPaste',
				'When enabled, automatically selects the text that was just pasted into the editor.'
			),
			tags: ['productivity']
		}
	}
		...
		this._register(
			this._editor.onDidChangeModelContent(e => {
				...
				this._editor.setSelection(
					new Selection(startPos.lineNumber, startPos.column, endPos.lineNumber, endPos.column)
				);
			})
		);
	}
...
registerEditorContribution(
	PasteSelectContribution.ID,
	PasteSelectContribution,
