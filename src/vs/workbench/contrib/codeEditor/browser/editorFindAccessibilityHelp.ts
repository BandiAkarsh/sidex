	...
	provideContent(): string {
		...
		if (isReplaceVisible) {
			...
			if (searchString) {
				...
				content.push(
					localize('replace.noSearchTerm', 'No search text entered yet. Start typing to find matches in the editor.')
				);
			}
			...
			content.push(
				localize('replace.keyShiftEnter', '- Shift+Enter: Move to the previous match while staying in Find.')
			);
			...
			content.push(
				localize('replace.keyF3', '- {0}: Move to the next match.', '<keybinding:editor.action.nextMatchFindAction>')
			);
			content.push(
				localize(
					'replace.keyShiftF3',
			...
			content.push(
				localize('replace.optionRegex', '- Regular Expression: Use pattern matching for advanced searches.')
			);
			content.push(localize('replace.optionSelection', '- Find in Selection: Limit matches to the current selection.'));
			content.push(
				localize('replace.optionPreserve', '- Preserve Case: When replacing, maintains the case of the original match.')
			);
			content.push('');
			...
			content.push(
				localize('replace.settingLoop', '- `editor.find.loop`: Wraps search at the beginning or end of the file.')
			);
			content.push(
				localize(
			...
			if (searchString) {
				...
				content.push(
					localize('find.noSearchTerm', 'No search text entered yet. Start typing to find matches in the editor.')
				);
			}
			content.push('');
			...
			content.push(
				localize('find.hear1', '1) The full line that contains the match is read first, so you get immediate context.')
			);
			content.push(
				localize(
					'find.hear2',
			...
			content.push(
				localize('find.keyShiftEnter', '- Shift+Enter: Move to the previous match while staying in the Find dialog.')
			);
			content.push('');
			content.push(localize('find.keyNavEditorHeader', 'While focused IN the editor (not the Find input):'));
			content.push(
				localize('find.keyF3', '- {0}: Move to the next match.', '<keybinding:editor.action.nextMatchFindAction>')
			);
			content.push(
				localize(
					'find.keyShiftF3',
			...
			content.push(
				localize('find.settingsIntro', 'These settings affect how Find behaves or how matches are highlighted.')
			);
			content.push(
				localize(
			...
			content.push(
				localize('find.settingLoop', '- `editor.find.loop`: Wraps search at the beginning or end of the file.')
			);
			content.push(
				localize(
			...
			content.push(
				localize('find.settingHistory', '- `editor.find.history`: Controls whether Find search history is stored.')
			);
			content.push(
				localize(
