...
suite('HistoryService', function () {
	...
	async function createServices(
		...
		[EditorPart, HistoryService, EditorService, ITextFileService, IInstantiationService, TestConfigurationService]
	> {
	...
	test('getHistory', async () => {
		...
		const input6 = disposables.add(
			new TestFileEditorInputWithUntyped(URI.file('file://bar1/node_modules/test.txt'), TEST_EDITOR_INPUT_ID)
		);
