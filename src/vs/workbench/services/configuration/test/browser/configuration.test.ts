...
suite('DefaultConfiguration', () => {
	...
	test('configuration default overrides are read from environment', async () => {
		...
		const testObject = disposables.add(
			new DefaultConfiguration('default', configurationCache, environmentService, new NullLogService())
		);
	...
	test('configuration default overrides are read from cache', async () => {
		...
		const testObject = disposables.add(
			new DefaultConfiguration('default', configurationCache, TestEnvironmentService, new NullLogService())
		);
